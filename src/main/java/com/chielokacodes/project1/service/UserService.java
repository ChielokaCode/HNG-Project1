...
package com.chielokacodes.project1.service;

import com.chielokacodes.project1.model.User;
import com.chielokacodes.project1.model.WeatherApiData;
...
public class UserService{
    ...
    public ResponseEntity<User> greetings(String visitor_name, HttpServletRequest request)  {
...
//        String clientIp = getPublicIpAddress();
        ...
        WeatherApiData weatherData = getWeatherData(city);
    ...
    public WeatherApiData getWeatherData(String city) {
        ...
        try {
            ...
            return new WeatherApiData(locationName, temperatureC);
